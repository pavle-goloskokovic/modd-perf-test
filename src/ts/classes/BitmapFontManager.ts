...
export default class BitmapFontManager {

    static REPLACEMENT_CHAR = String.fromCharCode(65533);
    ...
    static preload (scene: Phaser.Scene): void
    {
        ...
        load.bitmapFont('Verdana#FFFFFF',
            require('../../assets/images/Verdana.png'),
            require('../../assets/fonts/Verdana.xml')
        );
        load.image('VerdanaStroke#FFFFFF',
            require('../../assets/images/VerdanaStroke.png')
        );

        load.bitmapFont('VerdanaBold#FFFFFF',
            require('../../assets/images/VerdanaBold.png'),
            require('../../assets/fonts/VerdanaBold.xml')
        );
        load.image('VerdanaBoldStroke#FFFFFF',
            require('../../assets/images/VerdanaBoldStroke.png')
        );

        load.bitmapFont('ArialBold#FFFFFF',
            require('../../assets/images/ArialBold.png'),
            require('../../assets/fonts/ArialBold.xml')
        );
    }
